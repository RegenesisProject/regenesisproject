  ...
  return (
    <section className="bg-[#0C0A07] text-[#FFFFFF] py-12 sm:py-16 px-4 sm:px-8 border-t border-b border-[#C9962F]/30 relative overflow-hidden">
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <div className="inline-flex items-center justify-center gap-2 sm:gap-3 text-sm sm:text-base md:text-lg font-inter font-medium text-[#E6E1D5] hover:text-[#FFFFFF] transition-colors group flex-wrap">
