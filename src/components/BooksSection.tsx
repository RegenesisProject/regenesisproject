    ...
    <section id="books-section" className="py-20 sm:py-28 bg-[#F5F2EB] text-[#1A1A1A] relative overflow-hidden border-t border-b border-[#D4AF37]/25">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-serif font-extrabold text-[#111111] tracking-tight mb-3">
          ...
          <p className="max-w-3xl mx-auto text-sm sm:text-base text-[#555047] font-normal leading-relaxed">
