    ...
    <section className="bg-[#0C0A07] text-[#FFFFFF] py-10 sm:py-12 px-4 sm:px-8 border-t border-b border-[#C9962F]/30 relative overflow-hidden">
      <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left relative z-10">
        ...
        <button
          ...
          className="h-12 px-8 rounded-xl bg-gradient-to-r from-[#7E4F11] via-[#C9962F] to-[#E2B13D] text-[#000000] font-inter font-black text-xs uppercase tracking-[0.18em] flex items-center justify-center gap-2 cursor-pointer shadow-[0_4px_25px_rgba(226,177,61,0.35)] hover:shadow-[0_6px_35px_rgba(226,177,61,0.6)] hover:scale-105 transition-all duration-300 shrink-0"
        >
